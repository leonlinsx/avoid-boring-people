...
| `social-evergreen.yml` | Schedule Tue/Thu 09:37 and Sun 17:37 `America/New_York` (both DST offsets scheduled, then gated); manual dispatch | Republishes one eligible evergreen post, same state handling | Same as above |
