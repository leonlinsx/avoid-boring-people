...
I've also touched on art history before with articles on [Picasso](/writing/picasso 'picasso') and [Manet](/writing/art 'manet') if you want to check those out.
...
As a sidenote, if [aphantasia is real](/writing/aphantasia 'abp'), I probably have it, seeing as I'm a 3-4 on the below test. It hasn't been a hurdle when drawing from reference, though it might be one when drawing from imagination.
